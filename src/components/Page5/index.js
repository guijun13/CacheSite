...
function Page5(){
  ...
  **Definição:**
  ...
  Para fazer as políticas de substituição em cache, que são responsáveis por determinar qual dado deve ser substituído pelo novo dado que está sendo mandando para a cache. Para isso é necessário utilizar-se de bits de controle em cada bloco, sendo eles:
